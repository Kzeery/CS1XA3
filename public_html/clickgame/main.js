$(function() {
    ...
    $(".start").click(function() {
        ...
        const success = [new Audio('clickgame/sounds/success.wav'), new Audio('clickgame/sounds/success.wav'), new Audio('clickgame/sounds/success.wav'), new Audio('clickgame/sounds/success.wav'), new Audio('clickgame/sounds/success.wav')],
              failure = [new Audio('clickgame/sounds/failure.wav'), new Audio('clickgame/sounds/failure.wav')];
